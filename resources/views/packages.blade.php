    ...
    <div class="container position-relative" style="z-index: 1;">
      <div class="row align-items-start mb-4">
        ...
        <div class="col-md-6 mb-4">
          ...
          <p>
            This classic safari blends the urban charm of Nairobi with the untamed wilderness of the Masai Mara. Stay in
            top-tier accommodations in Nairobi before heading out for game drives, a hot air balloon experience, and
      ...
      <div class="row g-4 justify-content-center mb-4">
        ...
        <!-- karen blixen card -->
        <div class="col-md-3">
          <div class="card custom-card shadow-sm border-0 text-white position-relative overflow-hidden" role="button"
            data-bs-toggle="modal" data-bs-target="#karenBlixenModal" style="height: 200px;">
    ...
    <div class="container position-relative" style="z-index: 1;">
      <div class="row align-items-start mb-4">
        ...
        <div class="col-md-6 mb-4">
          ...
          <p>
            The ultimate "Out of Africa" safari experience combining two iconic safari camps and two of Kenya's most
            famous game parks.
            Explore the stunning views of Mt. Kilimanjaro and the rolling Chyulu Hills of Kenya's largest National Park,
            Tsavo.
            Finch Hattons is designed in the style of luxury safaris of a bygone era. Fly onto the vast open savannas of
            the world renowned
            Maasai Mara National Reserve to the luxury of Sir Richard Branson's Kenyan camp, Mahali Mzuri, nestled in a
            valley of the private
            Olare Motorogi Conservancy which offers the ultimate retreat for the last leg of your journey.
          </p>
      ...
      <div class="row g-4 justify-content-center mb-4">
        ...
        <div class="col-md-3">
          <div class="card custom-card h-150 shadow-sm border-0 text-white position-relative overflow-hidden"
            role="button" data-bs-toggle="modal" data-bs-target="#finchHattonsModal" style="height: 200px;">
        ...
        <div class="col-md-3">
          <div class="card custom-card h-150 shadow-sm border-0 text-white position-relative overflow-hidden"
            role="button" data-bs-toggle="modal" data-bs-target="#mahaliMzuriModal" style="height: 200px;">
        ...
        <div class="col-md-3">
          <div class="card custom-card h-150 shadow-sm border-0 text-white position-relative overflow-hidden"
            role="button" data-bs-toggle="modal" data-bs-target="#tsavoWestModal" style="height: 200px;">
        ...
        <div class="col-md-3">
          <div class="card custom-card h-150 shadow-sm border-0 text-white position-relative overflow-hidden"
            role="button" data-bs-toggle="modal" data-bs-target="#maasaiMaraModal" style="height: 200px;">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content bg-dark text-white">
        ...
        <div class="modal-body">
          ...
          <p class="mt-3">
            Discover the charm of the Karen Blixen Museum, once the home of the famed Danish author of *Out of Africa*.
            Nestled in the serene outskirts of Nairobi, this historic house provides a glimpse into colonial Kenya and
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content bg-dark text-white">
        ...
        <div class="modal-body">
          ...
          <p class="mt-3">
            Experience modern luxury at Radisson Blu Nairobi. Ideally located in the heart of the city, this upscale
            hotel features chic interiors, gourmet dining, serene spa services, and easy access to Nairobi’s major
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content bg-dark text-white">
        ...
        <div class="modal-body">
          ...
          <p class="mt-3">
            Conveniently located in the heart of Nairobi, Crown Plaza offers a seamless blend of comfort, business, and
            leisure—
      ...
      <div class="modal-content bg-dark text-white">
        ...
        <div class="modal-body">
          <div id="olengotiCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#olengotiCarousel" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#olengotiCarousel" data-bs-slide="next">
              <span class="carousel-control-next-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Next</span>
            </button>
          </div>
          <p class="mt-3">
            Nestled along the banks of the Talek River, Olengoti Safari Camp offers an immersive experience in the heart
            of the Maasai Mara—
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content bg-dark text-white">
        ...
        <div class="modal-body">
          ...
          <p class="mt-3">An elegant safari camp in Tsavo West National Park offering luxury in the wild and sweeping
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content bg-dark text-white">
        ...
        <div class="modal-body">
          ...
          <p class="mt-3">
            Sir Richard Branson’s exclusive safari camp in the private Olare Motorogi Conservancy in Maasai Mara.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content bg-dark text-white">
        ...
        <div class="modal-body">
          ...
          <p class="mt-3">
            A vast and rugged wilderness with lava flows, the Mzima Springs, and amazing wildlife diversity.
          </p>
        </div>
      </div>
    </div>
          ...
          <div id="maasaiMaraCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner rounded">
              ...
              <div class="carousel-inner rounded">
                ...
                <div class="carousel-item">
                  <img src="images/Maasai-Mara-National-Reserve.webp" class="d-block w-100" alt="Maasai Mara 2">
                </div>
                <div class="carousel-item">
            ...
            <p class="mt-3">One of Africa’s most iconic wildlife destinations, the Maasai Mara offers dramatic
              landscapes,
