        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <form class="contact-form" id="contactForm" data-aos="fade-up" data-aos-delay="200" method="POST"
                        action="#">
                        @csrf
                        <div class="row">
                            <div class="col-6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            contactForm.addEventListener('submit', function (event) {
                ...
                emailjs.send('service_qu1olnn', 'template_m2wzhyi', formData)
