...
<html lang="en">
    ...
    <body>
        ...
        <section class="hero">
            ...
            <div class="hero-text">
                <h1>Explore Tsavo</h1>
                <p>Embark on an unforgettable safari experience in the vast wilderness of Tsavo, home to diverse
                    wildlife and
              ...
              walks, night game drives, and cultural experiences.',
                                ...
                                @foreach ($chunks as $chunk)
                                    <div class="grid-page d-flex flex-wrap me-4" style="width: 520px;">
                                        @foreach ($chunk as $destination)
                                            <div class="location-card m-2 flex-shrink-0"
                                                onclick="showDetails(
                      '{{ $destination['name'] }}',
                    ...
                    <div class="col-md-6">
                        <div class="location-details text-center mt-4 mt-md-0">
                            <img id="location-image" src="{{ asset('images/fh-2.webp') }}" alt="Location"
                                class="img-fluid rounded mb-3" style="height: 250px; object-fit: cover;" />
                            <h3 id="location-title">Finch Hattons</h3>
                            <p id="location-desc" class="px-4">Located in Tsavo West National Park, Finch Hattons
                                offers a luxury safari
                                experience inspired
                                by the golden era of African safaris. The camp features elegant tented suites, a spa,
                                gourmet dining, and
                                stunning views of the Chyulu Hills and Mt. Kilimanjaro. Enjoy guided game drives, nature
                                walks, and
