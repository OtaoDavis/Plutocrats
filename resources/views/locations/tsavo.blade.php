        ...
        <div class="col-md-6 position-relative">
          ...
          <div class="locations-grid-wrapper">
            <div class="locations-grid">
              @foreach ([
              ['name' => 'Location 1 Tsavo', 'desc' => 'Desc', 'image' => 'angama.webp'],
              ['name' => 'Location 1 Tsavo', 'desc' => 'Desc', 'image' => 'mara_bush.webp'],
              ['name' => 'Location 1 Tsavo', 'desc' => 'Desc', 'image' => 'olare.webp'],
              ['name' => 'Location 1 Tsavo', 'desc' => 'Desc.', 'image' => 'rekero.webp'],
              ] as $destination)
              <div class="location-card"
                onclick="showDetails('{{ $destination['name'] }}', '{{ $destination['desc'] }}', '{{ asset('images/' . $destination['image']) }}')">
