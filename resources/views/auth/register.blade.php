                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="row mb-2">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control small-input @error('name') is-invalid @enderror"
                                    id="name" name="name" value="{{ old('name') }}" required>
                                @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="phone" class="form-label">Phone Number</label>
                                <input type="text" class="form-control small-input @error('phone') is-invalid @enderror"
                        ...
                        <div class="row mb-2">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="email"
                                    class="form-control small-input @error('email') is-invalid @enderror" id="email"
