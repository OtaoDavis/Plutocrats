    ...
    <div class="container">
      <div class="row">
        <div class="col-6 col-md-6 col-lg-3">
          <div class="media-1">
            <a href="#" class="d-block mb-3"><img src="images/hero-slider-1.png" alt="Image" class="img-fluid"></a>
            <div class="d-flex">
              <div>
    ...
    <div class="container">
      ...
      <div class="row align-items-stretch">
        <div class="col-lg-4 order-lg-1">
          <div class="h-100">
            <div class="frame h-100">
              <div class="feature-img-bg h-100" style="background-image: url('images/hero-slider-5.png');"></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-6 col-sm-6 col-lg-4 feature-1-wrap d-md-flex flex-md-column order-lg-1">
          ...
          <div class="feature-1 d-md-flex">
            <div class="align-self-center">
              <span class="bi bi-car-front-fill display-4 text-primary"></span>
              <h3>Exquisite Game Drives</h3>
              <p class="mb-0">Experience thrilling wildlife encounters with expert safari guides.</p>
            </div>
          </div>
          ...
          <div class="feature-1 ">
            <div class="align-self-center">
              ...
              <h3>Safari Dining</h3>
              <p class="mb-0">Ever had a meal in the wild? Join us to experience some of the Best
                quisines in the heart of the wild
              </p>
            </div>
          </div>
        ...
        <div class="col-6 col-sm-6 col-lg-4 feature-1-wrap d-md-flex flex-md-column order-lg-3">
          ...
          <div class="feature-1 d-md-flex">
            <div class="align-self-center">
              <span class="bi bi-person-walking display-4 text-primary"></span>
              <h3>Scenic Hiking Trails</h3>
              <p class="mb-0">Explore breathtaking landscapes on guided nature walks and mountain hikes.
              </p>
            </div>
          </div>
          ...
          <div class="feature-1 d-md-flex">
            <div class="align-self-center">
              ...
              <h3>Private Plane Charters</h3>
              <p class="mb-0">If you think the game drives are breathtaking then you will have to
                experience our private plane charters. Don't have to worry about lions chasing you in
                the sky😉
              </p>
            </div>
          </div>
