  ...
  <nav class="site-nav">
    <div class="container">
      <div class="site-navigation">
        ...
        <!-- <a href="index.html" class="logo m-0">Tours and Travel <span class="text-primary">.</span></a> -->
    ...
    <div class="container my-5">
      <div class="mb-5">
        <div class="owl-single dots-absolute owl-carousel">
          <img src="images/hero-slider-1_land.jpg" alt="image" class="img-fluid">
          <img src="images/hero-slider-2_land.jpg" alt="image" class="img-fluid">
          <img src="images/hero-slider-5 land.jpg" alt="image" class="img-fluid">
        </div>
      </div>
        ...
        <div class="col-lg-4">
              ...
              <div class="accordion-item">
                <h2 class="mb-0">
                  <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne"
                    aria-expanded="true" aria-controls="collapseOne">How to register?</button>
                </h2>
              ...
              <div class="accordion-item">
                <h2 class="mb-0">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo"
                    aria-expanded="false" aria-controls="collapseTwo">What is in the package</button>
                </h2>
              ...
              <div class="accordion-item">
                <h2 class="mb-0">
                  <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                    data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">More FAQ</button>
                </h2>
          ...
          <div class="custom-block" data-aos="fade-up">
            ...
            <div class="row gutter-v2 gallery">
              <div class="col-4">
                <a href="images/hero-slider-3.jpg" class="gal-item" data-fancybox="gal"><img
                    src="images/hero-slider-3.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4">
                <a href="images/hero-slider-2.jpg" class="gal-item" data-fancybox="gal"><img
                    src="images/hero-slider-2.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4">
                <a href="images/hero-slider-4.jpg" class="gal-item" data-fancybox="gal"><img
                    src="images/hero-slider-4.jpg" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4">
                <a href="images/hero-slider-1.png" class="gal-item" data-fancybox="gal"><img
                    src="images/hero-slider-1.png" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4">
                <a href="images/hero-slider-5.png" class="gal-item" data-fancybox="gal"><img
                    src="images/hero-slider-5.png" alt="Image" class="img-fluid"></a>
              </div>
              <div class="col-4">
                <a href="images/hero-slider-2.jpg" class="gal-item" data-fancybox="gal"><img
                    src="images/hero-slider-2.jpg" alt="Image" class="img-fluid"></a>
          ...
          <div class="custom-block" data-aos="fade-up">
            ...
            <a href="https://vimeo.com/342333493" data-fancybox class="video-wrap">
              ...
              <img src="images/hero-slider-1_land.jpg" alt="Image" class="img-fluid rounded">
            </a>
          </div> <!-- END .custom-block -->
        </div>
        <div class="col-lg-4">
          <div class="custom-block" data-aos="fade-up" data-aos-delay="100">
            ...
            <form class="contact-form bg-white">
              ...
              <div class="form-group">
                <label class="text-black" for="select">Destinations</label>

                <select name="" id="select" class="custom-select" placeholder="Destinations">
    ...
    <div class="container">
      <div class="row text-center">
        <div class="col-md-12">
          ...
          <p class="mb-4 lead text-white text-white-opacity">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            Excepturi, fugit?</p>
